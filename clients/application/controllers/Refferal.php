...
class Refferal extends Smart_Controller {
	...
	public function index()
	{
		...
		$in['use_hedaer'] = true;
		$in['title'] = 'Refferal';
		$in['desc'] = 'you can manage your Grade here';
		$in['bread']['list'] = '';
	...
	public function getlist()
	{
		if($this->input->is_ajax_request())
		{
			...
			array('db'=>"m_v_customer.name",'dt'=>1,'alias'=>'name'),
			array('db'=>"m_v_customer.telp",'dt'=>2,'alias'=>'telp'),
			...
			$table = 'm_v_customer';
			$whereResult = NULL;
			$whereAll = "m_v_customer.refferal='".user_info('id')."'";
