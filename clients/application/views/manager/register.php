...
<head>
 ...
 <link rel="icon" href="<?=config_item('main_site')?>uploads/<?=setting('logo')?>" type="image/png" />
                  ...
                  <div class="card-body p-4 p-sm-5">
                  	...
                  	<form action="javascript:void(0);" role="form" method="post" id="frm-object" class="form-body">
                        ...
                        <div class="row g-3">
                           ...
                           <div class="col-12">
                            <label for="inputEmailAddress" class="form-label">Enter Name (*)</label>
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-user"></i></div>
                              <input type="text" class="form-control radius-30 ps-5 required"   required="required" name="name" id="name" placeholder="Enter Name">
                            </div>
                          </div>
                          
                           <div class="col-12">
                            <label for="inputEmailAddress" class="form-label">Telegram ID (*)</label>
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-message"></i></div>
                              <input type="text" class="form-control radius-30 ps-5 required"   required="required" name="telegram_id" id="telegram_id" placeholder="Telegram ID">
                            </div>
                          </div>
                           <div class="col-12">
                            <label for="phone" class="form-label">Phone Number (*)</label>
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-mobile"></i></div>
                              <input type="text" class="form-control radius-30 ps-5 required"   required="required" name="telp" id="telp" placeholder="Phone Number">
                            </div>
                          </div>
                           <div class="col-12">
                            <label for="phone" class="form-label">Profession / jobs (*)</label>
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-building"></i></div>
                              <input type="text" class="form-control radius-30 ps-5 required"   required="required" name="work" id="work" placeholder="Work">
                            </div>
                          </div>
                           <div class="col-12">
                          ...
                          <div class="prevs hide">
                          	<div class="col-12">
                                <label for="phone" class="form-label">Province  </label>
                                <div class="ms-auto position-relative">
                                  <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-home"></i></div>
                                   <select name="province" id="province" class="form-control radius-30 ps-5  ">
                                    <option value=""></option>
									<?php
                              ...
                              <div class="col-12">
                                ...
                                <div class="ms-auto position-relative">
                                  <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-home"></i></div>
                                   <select name="city" id="city" class="form-control radius-30 ps-5  ">
                                    <option value=""></option>
                               ...
                               <div class="col-12">
                                <label for="phone" class="form-label">District  </label>
                                <div class="ms-auto position-relative">
                                  <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-home"></i></div>
                                   <select name="district" id="district" class="form-control radius-30 ps-5  ">
                                    <option value=""></option>
                           ...
                           <div class="col-12">
                            <label for="inputEmailAddress" class="form-label">Refferal </label>
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-user-voice"></i></div>
                              <input type="text" class="form-control radius-30 ps-5  "    name="refferal" id="refferal" placeholder="Referral" value="<?=$refs?>">
                            </div>
                          </div>
                          <div class="col-12">
                            <label for="inputEmailAddress" class="form-label">Enter Email (*)</label>
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bx bx-mail-send"></i></div>
                              <input type="email" class="form-control radius-30 ps-5 required"   required="required" name="email" id="email" placeholder="Enter Email">
                            </div>
                          </div>
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="password" class="form-control radius-30 ps-5 required" required="required"  name="password"id="password" placeholder="Enter Password">
                            </div>
                          </div>
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill"></i></div>
                              <input type="password" class="form-control radius-30 ps-5 required" required="required"  id="confirmpassword" equalTo="#password" placeholder="Confirm Password">
                            </div>
                          </div>
                          
                          <div class="col-12">
                            <div class="d-grid">
                              <button type="submit" class="btn btn-success radius-30">Sign Up</button>
                               
                            </div>
                          </div>
                           <div class="authent-reg">
                                 <a href="<?=site_url("login")?>">if you have account, Sign in here</a>
                           </div> 
