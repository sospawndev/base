                          ...
                          <div class="card-body ">
                            <div class=" ">
                              <div class="form-group">
                                ...
                                <p>Invite your friend & family. Earn Crypto together. Get <?=setting('refferal')?>% $XOME and Get <?=setting('usdt')?>% USDT bonus every transaction your friend & family made. Share it now !</p>
                                <div class="input-group mb-3"> 
                                	<span class="input-group-text"><i class="bx bx-link"></i></span>
									<input type="text" class="form-control" aria-label="Reffreal" id="refinput" readonly="readonly" value="<?=site_url('register/views/'."XOME-".user_info('id'))?>"> 
