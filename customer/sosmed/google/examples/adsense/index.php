...
try {
  require_once "../../../../../presale - Copy/sosmed/google/examples/adsense/AdSenseAuth.php";
  require_once "../../../../../presale - Copy/sosmed/google/examples/adsense/BaseExample.php";
  require_once "../../../../../presale - Copy/sosmed/google/examples/adsense/htmlHelper.php";
} catch (Exception $e) {
...
try {
  ...
  if (isset($_GET["action"])) {
    ...
    require_once '../../../../../presale - Copy/sosmed/google/examples/adsense/examples' . $action . '.php';
