...
class PHP_Token_IncludeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetIncludesCategorized()
    {
        $this->assertSame(
          array(
            'require_once'../../../../../../../../presale - Copy/sosmed/facebook/vendor/phpunit/php-token-stream/tests/Token/ => array('test4.php'),
            'require'../../../../../../../../presale - Copy/sosmed/facebook/vendor/phpunit/php-token-stream/tests/Token/      => array('test3.php'),
            'include_once'../../../../../../../../presale - Copy/sosmed/facebook/vendor/phpunit/php-token-stream/tests/Token/ => array('test2.php'),
            'include'../../../../../../../../presale - Copy/sosmed/facebook/vendor/phpunit/php-token-stream/tests/Token/      => array('test1.php')
          ),
