                                        ...
                                        <fieldset class="4 xhide">
                                            <div class="form-card">
                                                ...
                                                <h4 class="pt-1 mb-n1 font-16  "><?=custom_language('Input Your tx id after transfer')?></h4>
                                     			...
                                     			<input type="text" class="form-control exchange-value   rounded-xs" id="tx_hash" name="tx_hash" placeholder="0x"  />
                                                <!-- -->
                                                 ...
                                                 <input type="hidden" value="" name="total" id="total" /> 
                                                  <input type="button"   class="previous action-button-previous" value="Previous"/>
                                            	  <input type="submit"   class="action-button" value="Top Up"/>
                                            </div>
                                        </fieldset>
	...
	$("#msform").validate({
		...
		submitHandler:function(){
			...
			req.done(function(out){
				if(!out.error)
				{
					document.location.href="<?=site_url('activity')?>";
				}
				else
				{
