           ...
           <div class="content">
               ...
               */
               ...
               <div class="row" connectwallet id="vm">
                   <div class="col-12 text-start">
                       <a href="javascript:void(0);"  id="btn_change" class="btn btn-full bg-red-dark shadow-bg shadow-bg-s mt-4"><i class="fa fa-wallet"></i> Metamask</a>
                   </div>
			   ...
			   <div class="form-custom form-label form-border form-icon mb-3 bg-transparent">
                   ...
                   <input type="text" class="form-control required rounded-xs" name="email" id="email"  placeholder="Email"/>
               ...
               <div class="form-custom form-label form-border form-icon mb-4 bg-transparent">
                   ...
                   <input type="password" class="form-control required rounded-xs" name="password" id="password"placeholder="Password"/>
                   <label for="c2" class="color-theme">Password</label>
                   <a href="javascript:void(0);" class="shows-eye"><i class="bi bi-eye "></i></a>
                   <span>(required)</span>
               </div>
               ...
               <button   class="btn btn-full gradient-highlight shadow-bg shadow-bg-s mt-4" style="width:100%;">SIGN IN</button>
               <hr/>
               <div class="row">
                   <?php
				   /*
                   ...
                   <div class="col-6 text-end">
                       <a href="register.html" class="btn btn-full gradient-highlight shadow-bg shadow-bg-s mt-4">Create Account</a>
                   </div>
				   */
				   ?>
