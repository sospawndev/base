                      	...
                      	<div class="col-12" style="min-height:400px;">
                             ...
                             <form action="javascript:void(0);" method="post" id="frm-screenshot">  
                                ...
                                <div class="form-group">
                                   	...
                                   	<div class="form-group">
                                    	<label>Note</label>
                                        <textarea class="form-control required" placeholder="please add your comment at least 10 character and put your id account with '@' at the end" minlength="10" name="prove"></textarea>
                                    </div>                    
                                    <hr/>
                                    <div class="form-group">
