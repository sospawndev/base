            ...
            <div class="content">
                <div class="tabs tabs-pill" id="tab-group-2">
                    <div class="tab-controls rounded-m p-1 overflow-visible">
                        ...
                        <a class="font-13 rounded-m shadow-bg shadow-bg-s tab-tf tabsb" data-bs-toggle="collapse" href="#tab-tf" aria-expanded="false"><?=custom_language('Transfer')?></a>
                        <a class="font-13 rounded-m shadow-bg shadow-bg-s tab-wd tabsb" data-bs-toggle="collapse" href="#tab-wd" aria-expanded="false"><?=custom_language('Withdrawal')?></a>
                        <a class="font-13 rounded-m shadow-bg shadow-bg-s tab-buy tabsb" data-bs-toggle="collapse" href="#tab-buy" aria-expanded="false"><?=custom_language('Buy')?></a>
                       ...
                       <?php
                        ...
                        <div  class="d-flex py-1"  >
                            ...
                            <div class="align-self-center ms-auto text-end">
                                ...
                                <p class="mb-0 font-11"><?=custom_language("Transfer")?></p>
                            </div>
                        </div>
                        <?php
							}
						...
						?> 
                        		<a href="#" class="d-flex py-1" data-bs-toggle="offcanvas" data-bs-target="#menu-wd-<?=$withdraw[$i]['id']?>">
                                    ...
                                    <div class="align-self-center ms-auto text-end">
                                        ...
                                        <p class="mb-0 font-11"><?=custom_language(payments($withdraw[$i]['status']))?></p>
                                    </div>
                                </a>
                        <?php
							}
                    ...
                    <div class="collapse  coltab" id="tab-buy" data-bs-parent="#tab-group-2">
                        ...
                        <a href="javascript:void(0);" class="d-flex py-1"  data-bs-toggle="offcanvas" data-bs-target="#menu-buy-<?=$buy[$i]['id']?>">
                            ...
                            <div class="align-self-center ms-auto text-end">
                                ...
                                <p class="mb-0 font-11"> <?=custom_language(payments($buy[$i]['status']))?></p>
                            </div>
