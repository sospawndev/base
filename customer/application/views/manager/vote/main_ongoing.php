                 ...
                 <!-- -->
                  <div class="tabs tabs-pill" id="tab-group-2">
                    <div class="tab-controls rounded-m p-1 overflow-visible">
                         ...
                         <a class="font-13 rounded-m shadow-bg tab_ongoing shadow-bg-s tabsb"  href="<?=site_url("vote/on-going")?>" aria-expanded="true">On Going</a>
                       
                       
                         <a class="font-13 rounded-m shadow-bg shadow-bg-s tab_completed tabsb"   href="<?=site_url("vote/completes")?>" aria-expanded="false">Completes</a>
