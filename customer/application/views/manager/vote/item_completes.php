                                                           ...
                                                           <div class="card-body padding-0 margin-0 card-task">
                                                             ...
                                                             <div class="card-body  card-task" style="min-height:100px;">
                                                               ...
                                                               <h1 class="text-left">
																...
																?>
                                                                <?=$arr[$i]['vote_complete']?> Pemilih, <?=$arr[$i]['days']?> Hari Lagi
                                                               <hr/>
                                                               <?php
															   	
																if((strtotime($arr[$i]['end_dates'])<time()) && !isset($arr[$i]['user_reward']['id']))
																{
															   ?>
                                                                <span  class="alert alert-danger form-control text-center" style="">Waktu Vote Berakhir</span>
															   <?php
																}else
																{
																	if(isset($arr[$i]['user_reward']['id']))
															   ...
															   ?> 
                                                               			 <span  class="alert alert-info form-control text-center" style="">You Vote <b><?=$arr[$i]['user_reward']['vote_name']?></b></span>
                                                                <?php
																	}
																}
															   ?>
