                                                           ...
                                                           <div class="card-body padding-0 margin-0 card-task">
                                                             ...
                                                             <div class="card-body  card-task" style="min-height:100px;">
                                                               ...
                                                               <?php
																...
																{
															   ?> 
                                                               <a href="<?=site_url("vote/details/".$arr[$i]['id'])?>?type=ongoing" class="btn btn-sm btn-xs btn-lg btn-full" style="background:<?=$bgcolor?>;"><?=$names?></a>
                                                             <?php
																}else
																{
															 ?>
                                                             		<span class="btn btn-danger btn-sm btn-xs btn-lg btn-full" style="cursor:default;"  >Complete The Task To Get Vote</span>
                                                             <?php
																}
															 ?>
                                                             </div>
