...
class PHP_Token_Stream implements ArrayAccess, Countable, SeekableIterator
{
     ...
     * @param string $category   OPTIONAL Either 'require_once'../../../../../../../presale - Copy/libs/vendor_/phpunit/php-token-stream/src/Token/, 'require',
     *                                           'include_once'../../../../../../../presale - Copy/libs/vendor_/phpunit/php-token-stream/src/Token/, 'include'.
     * @return array
     * @since  Method available since Release 1.1.0
     */
