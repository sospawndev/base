...
function smart_success_box(message,container)
{
	...
	var str =  '<div class="alert alert-success alert-dismissable smart-success-box"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><p><i class="fa fa-check"></i> '+message+'</p></div>';
...
function smart_error_box(message,container)
{
	...
	var str =  '<div class="alert alert-danger alert-dismissable smart-error-box"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><p><i class="fa fa-warning"></i> '+message+'</p></div>';
	$(str).prependTo(container);
}
