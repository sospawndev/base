...
smart_loader +='                    </svg>';
smart_loader +='<span class="loader-logo"><img class="img-responsive" src="../../../../presale - Copy/assets/skodash/assets/assets/img/lewatpasar-logo-icon.png" alt="Lewat Pasar"></span>';
smart_loader +='               </div>';
smart_loader +='        </div>';*/
