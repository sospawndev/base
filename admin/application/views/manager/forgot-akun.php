                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <form action="javascript:void(0);" role="form" method="post" class="js-validation-login">
                                         <h6 class="text-center">Instruksi Forgot Akun ke email Anda</h6>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block btn-submit">Process</button>
		...
		<script>
          $(document).ready(function(){
             ...
             $('#pincode-input1').pincodeInput({inputs:6,hidedigits:false,complete:function(value, e, errorElement){
                   // check the code
                   var req = post('<?=site_url('forgot/save')?>',{code:value,pid:'<?=$pid?>','<?=$this->security->get_csrf_token_name()?>':smart_token_hash});
