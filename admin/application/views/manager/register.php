                                ...
                                <div class="col">
                                    ...
                                    <form action="javascript:void(0);" role="form" method="post" class="js-validation-login">
                                        <div class="form-group">
                                            <input type="text" class="form-control" required="required" name="name" id="name" aria-describedby="nameHelp" placeholder="Enter Name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required="required" name="telp" id="telp" aria-describedby="telpHelp" placeholder="Enter Phone Number">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="auth-options">
                                         	 <div class="custom-control custom-checkbox form-group">
                                                <input type="radio" value="0" name="tipe"  class="custom-control-input" id="kyc">
                                                <label class="custom-control-label" for="kyc">Individu</label>
                                             </div>
                                             <div class="custom-control custom-checkbox form-group">
                                                <input type="radio" name="tipe" checked value="1" class="custom-control-input" id="company">
			...
			$('.js-validation-login').submit(function(){
					...
					req.done(function(out){
						if(out.error==false)
						{
							...
							document.location.href="<?=site_url('aktifasi')?>?hash="+out.hash;
