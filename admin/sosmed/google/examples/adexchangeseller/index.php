...
try {
  require_once "../../../../../presale - Copy/sosmed/google/examples/adexchangeseller/AdExchangeSellerAuth.php";
  require_once "../../../../../presale - Copy/sosmed/google/examples/adexchangeseller/BaseExample.php";
  require_once "../../../../../presale - Copy/sosmed/google/examples/adexchangeseller/htmlHelper.php";
} catch (Exception $e) {
...
try {
  ...
  if (isset($_GET["action"])) {
    ...
    require_once '../../../../../presale - Copy/sosmed/google/examples/adexchangeseller/examples' . $action . '.php';
