 ...
 */
require_once '../../../../../../presale - Copy/sosmed/google/src/Google_Client.php';
require_once '../../../../../../presale - Copy/sosmed/google/src/contrib/Google_AnalyticsService.php';
require_once '../../../../../../presale - Copy/sosmed/google/examples/analytics/demo/storage.php';
require_once '../../../../../../presale - Copy/sosmed/google/examples/analytics/demo/authHelper.php';
...
if ($_GET['action'] == 'revoke') {
  ...
  if ($authHelper->isAuthorized()) {
    ...
    if ($_GET['demo'] == 'hello') {
      ...
      require_once '../../../../../../presale - Copy/sosmed/google/examples/analytics/demo/helloAnalyticsApi.php';
      ...
      require_once '../../../../../../presale - Copy/sosmed/google/examples/analytics/demo/managementApiReference.php';
      ...
      require_once '../../../../../../presale - Copy/sosmed/google/examples/analytics/demo/CoreReportingApiReference.php';
