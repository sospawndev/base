...
try {
  require_once "../../../../../presale - Copy/sosmed/google/examples/adsensehost/AdSenseHostAuth.php";
  require_once "../../../../../presale - Copy/sosmed/google/examples/adsensehost/BaseExample.php";
  require_once "../../../../../presale - Copy/sosmed/google/examples/adsensehost/htmlHelper.php";
} catch (Exception $e) {
...
try {
  ...
  if (isset($_GET["action"])) {
    ...
    require_once '../../../../../presale - Copy/sosmed/google/examples/adsensehost/examples' . $action . '.php';
